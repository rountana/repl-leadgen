...
export function Profile() {
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-2xl flex items-center justify-center h-64">
    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>Used on your lead magnet pages. PNG or JPG under 2MB.</CardDescription>
        </CardHeader>
