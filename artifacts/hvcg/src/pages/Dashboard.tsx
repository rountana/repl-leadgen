  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          { title: "Total Pages", value: summary?.total ?? 0, icon: <BarChart3 className="w-5 h-5 text-primary" />, color: "bg-primary/10" },
              ...
              <Card key={magnet.id} className="overflow-hidden hover:border-primary/50 transition-colors">
                <div className="flex flex-col sm:flex-row">
                  <div className="p-6 flex-1">
                    ...
                    <h3 className="text-xl font-bold mb-1">{magnet.title || "Untitled Page"}</h3>
